...
describe Admin::TimeOffRequestsController do
  ...
  describe "GET show" do
    it "should show the current request" do
      time_off_request = TimeOffRequest.create! valid_attributes
      TimeOffRequest.stub(:show).and_return(time_off_request)
  ...
  describe "DELETE destroy" do
    it "should delete other employees' time_off_request" do
      time_off_request = TimeOffRequest.create! valid_attributes
      expect {
    ...
    it "redirects to the time_off_requests list" do
      time_off_request = TimeOffRequest.create! valid_attributes
      delete :destroy, {:id => time_off_request.to_param}, valid_session
      response.should redirect_to(admin_time_off_requests_url)
    end
  end
