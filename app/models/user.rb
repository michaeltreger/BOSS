class User < ActiveRecord::Base
  ...
  EMPLOYEE = Group.find_or_create_by_name(:name => "Employee", :description => "All users in are employees.").id
  ALL_USERS = Group.find_or_create_by_name(:name => "All Users", :description => "All users in this group by default.").id
